...
adventurer_level_1_quest_3 = Quest.create(level: 1, categorie: "SOCIAL", title: "A Padawan needs a Jedi", content: "Who do you admire ? Who was your hero when you were younger? Choose at least 2 persons (fictional or real) that inspire you. What values do they have ? ",
...
adventurer_level_1_quest_5 = Quest.create(level: 1, categorie: "SOCIAL", title: "A positive icon", content: " For the next hour only talk in positive sentence. Heroes need to be positive in order to overcome the difficulties they might face.",
...
adventurer_level_2_quest_1 = Quest.create(level: 2, categorie: "SOCIAL", title: "Breathing exercices under the waterfall", content: "When you talk in a group, you might feel like cold water has been splashed to your face. Take a deep breathe, recenter yourself, release the knot in your stomach. Repeat each time you open your mouth",
...
adventurer_level_2_quest_2 = Quest.create(level: 2, categorie: "SOCIAL", title: "Don't worry for I am here !", content: "After you wake up take a 'hero pose' during 2 minutes : hands on the hips, back straight, legs wide.",
...
adventurer_level_2_quest_3 = Quest.create(level: 2, categorie: "SOCIAL", title: "Walking, running, flying", content: "Healthy mind, healthy body ! Both need to be worked together to become a hero. Exercise at least 2 times this week",
...
adventurer_level_2_quest_4 = Quest.create(level: 2, categorie: "SOCIAL", title: "I am a hero", content: "Today we're going to visualize our goals! Find somewhere quiet, get comfortable, close your eyes and picture in your mind the things that you want in your life.",
...
adventurer_level_2_quest_5 = Quest.create(level: 2, categorie: "SOCIAL", title: "Peaceful kingodom", content: "Take an inventory of your quests so far:your successes, your failures, your likes and dislikes. You're only at the beginning of your journey, it's normal to struggle. You can't expect to slay a dragon so early in the game...",
